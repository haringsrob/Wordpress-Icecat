...
$fields = [
  [
    ...
    'field_default' => 'en',
    'field_info' => __('Set the language of the fetched data.', 'icecat'),
  ],
  [
    'field_group' => 'group_basic_config',
    ...
    'field_required' => FALSE,
    'field_default' => 1,
    'field_info' => __('If the product is not available in your language, try to download the english version.', 'icecat'),
  ],
  [
    'field_group' => 'group_basic_config',
    ...
    'field_required' => FALSE,
    'field_default' => 1,
    'field_info' => __('Disable, if you only want to use WP All Import.', 'icecat'),
  ],
  [
  ...
  [
    ...
    'field_title' => __('Update product/page title', 'icecat'),
  ...
  [
    'field_group' => 'group_basic_data',
    'field_title' => __('Update product/page body', 'icecat'),
  ...
  [
    'field_group' => 'group_basic_data',
    'field_title' => __('Download product images', 'icecat'),
  ...
  [
    'field_group' => 'group_basic_data',
    'field_title' => __('Download product specifications', 'icecat'),
  ...
  [
    ...
    'field_title' => __('Enable for WooCommerce', 'icecat'),
  ...
  [
    ...
    'field_required' => FALSE,
    'field_default' => 0,
    'field_info' => __('Download multiple images via WP All Import.', 'icecat'),
    'requiredplugin' => 'wp-all-import-pro/wp-all-import-pro.php',
  ],
  [
    'field_group' => 'group_wpallimport',
