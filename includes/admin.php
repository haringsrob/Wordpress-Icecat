...
// Open the form tag.
?>
<link href="<?=plugin_dir_url(__FILE__)?>../assets/css/icecatadmin.css" rel="stylesheet">
<form name="icecat_settings_form" method="post" action="<?=str_replace('%7E', '~', $_SERVER['REQUEST_URI'])?>">
